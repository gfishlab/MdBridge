...
- **灵活图片导入** — 支持粘贴图片、本地绝对/相对路径、指定目录，以及 PicGo Server/CLI 图床上传
...
可配置图片导入方式、PicGo 图床、图片缓存大小、默认发布平台和启动时检查更新等。PicGo CLI 会优先自动使用本机 PicGo Desktop 配置，无需手动填写配置文件路径。
